datablock fxDTSBrickData (BrickRamBot_HoleSpawnData)
{
...
datablock PlayerData(RamHoleBot : PlayerStandardArmor)
{
	shapeFile = "Add-Ons/Player_FarmAnimals/Ram.dts";
	uiName = "Ram";
	minJetEnergy = 0;
	jetEnergyDrain = 0;
	canJet = 0;
	...
	hName = "Ram";//cannot contain spaces
	hTickRate = 3000;
