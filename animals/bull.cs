datablock fxDTSBrickData (BrickBullBot_HoleSpawnData)
{
...
datablock PlayerData(BullHoleBot : PlayerStandardArmor)
{
	shapeFile = "Add-Ons/Player_FarmAnimals/Bull.dts";
	uiName = "Bull";
	minJetEnergy = 0;
	jetEnergyDrain = 0;
	canJet = 0;
	...
	hName = "Bull";//cannot contain spaces
	hTickRate = 3000;
