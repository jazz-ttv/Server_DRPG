datablock fxDTSBrickData (BrickTurkeyBot_HoleSpawnData)
{
	...
	isBotHole = 1;
	holeBot = "TurkeyHoleBot";
};

datablock PlayerData(TurkeyHoleBot : PlayerStandardArmor)
{
	shapeFile = "Add-Ons/Player_FarmAnimals/Turkey.dts";
	uiName = "Bear";
	minJetEnergy = 0;
	jetEnergyDrain = 0;
	canJet = 0;
	...
	hName = "Turkey";//cannot contain spaces
	hTickRate = 3000;
