datablock fxDTSBrickData (BrickGoatBot_HoleSpawnData)
{
...
datablock PlayerData(GoatHoleBot : PlayerStandardArmor)
{
	shapeFile = "Add-Ons/Player_FarmAnimals/Goat.dts";
	uiName = "Goat";
	minJetEnergy = 0;
	jetEnergyDrain = 0;
	canJet = 0;
	...
	hName = "Goat";//cannot contain spaces
	hTickRate = 3000;
