...
// Crops
drpgAddRecipe("RECIPE_FLOUR","Flour","Materials","cooking",1,"WHEAT 2","%client.addItem(FLOUR,1);",0.7*$DRPG::Prefs::ExpMultiplier["cooking"]);
drpgAddRecipe("RECIPE_COOKED_TURKEY","Cooked Turkey","Meat","cooking",5,"TURKEY 1\tOAK_WOOD 1","%client.addItem(COOKED_TURKEY,1);",0.7*$DRPG::Prefs::ExpMultiplier["cooking"]);
drpgAddRecipe("RECIPE_COOKED_MUTTON","Cooked Mutton","Meat","cooking",15,"MUTTON 1\tOAK_WOOD 1","%client.addItem(COOKED_MUTTON,1);",0.7*$DRPG::Prefs::ExpMultiplier["cooking"]);
drpgAddRecipe("RECIPE_COOKED_BEEF","Cooked Beef","Meat","cooking",25,"BEEF 1\tOAK_WOOD 1","%client.addItem(COOKED_BEEF,1);",0.7*$DRPG::Prefs::ExpMultiplier["cooking"]);
drpgAddRecipe("RECIPE_COOKED_RAM","Cooked Ram","Meat","cooking",35,"RAM_MEAT 1\tOAK_WOOD 1","%client.addItem(COOKED_RAM,1);",0.7*$DRPG::Prefs::ExpMultiplier["cooking"]);
...
drpgAddRecipe("RECIPE_SPEED_POTION","Speed Potion","Potions","alchemy",5,"ACCURIS_HERB 1\tGUNDOR_HERB 1","%client.addItem(SPEED_POTION,1);",1.4);
drpgAddRecipe("RECIPE_DEFENSE_POTION","Defense Potion","Potions","alchemy",10,"DEFTORA_HERB 1","%client.addItem(DEFENSE_POTION,1);",1.4);
drpgAddRecipe("RECIPE_ATTACK_POTION","Attack Potion","Potions","alchemy",15,"DAMAC_HERB 1","%client.addItem(ATTACK_POTION,1);",1.4);
